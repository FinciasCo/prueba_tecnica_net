...
namespace eSett.API
{
    ...
    public partial class OpenData 
    {
        ...
        public OpenData(System.Net.Http.HttpClient httpClient)
        {
    ...
    public partial class SinglebalancePriceDTO
    {
        ...
        [Newtonsoft.Json.JsonProperty("incentivisingComponent", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("valueOfAvoidedActivation", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
